...
`define ROUTER_OP_LUT_BLOCK_ADDR_WIDTH  16
`define ROUTER_OP_LUT_REG_ADDR_WIDTH    7
...
`define ROUTER_OP_LUT_BLOCK_ADDR  16'h0000
`define STRIP_HEADERS_BLOCK_ADDR  17'h00002
`define IN_ARB_BLOCK_ADDR         17'h00003
`define RATE_LIMIT_0_BLOCK_ADDR   19'h00010
`define RATE_LIMIT_1_BLOCK_ADDR   19'h00011
`define RATE_LIMIT_2_BLOCK_ADDR   19'h00012
`define RATE_LIMIT_3_BLOCK_ADDR   19'h00013
`define EVT_CAP_BLOCK_ADDR        17'h00005
...
// File: lib/verilog/core/output_port_lookup/cam_router/xml/cam_router.xml
`define ROUTER_OP_LUT_ARP_NUM_MISSES                 7'h0
`define ROUTER_OP_LUT_LPM_NUM_MISSES                 7'h1
`define ROUTER_OP_LUT_NUM_CPU_PKTS_SENT              7'h2
`define ROUTER_OP_LUT_NUM_BAD_OPTS_VER               7'h3
`define ROUTER_OP_LUT_NUM_BAD_CHKSUMS                7'h4
`define ROUTER_OP_LUT_NUM_BAD_TTLS                   7'h5
`define ROUTER_OP_LUT_NUM_NON_IP_RCVD                7'h6
`define ROUTER_OP_LUT_NUM_PKTS_FORWARDED             7'h7
`define ROUTER_OP_LUT_NUM_WRONG_DEST                 7'h8
`define ROUTER_OP_LUT_NUM_FILTERED_PKTS              7'h9
`define ROUTER_OP_LUT_MAC_0_HI                       7'ha
`define ROUTER_OP_LUT_MAC_0_LO                       7'hb
`define ROUTER_OP_LUT_MAC_1_HI                       7'hc
`define ROUTER_OP_LUT_MAC_1_LO                       7'hd
`define ROUTER_OP_LUT_MAC_2_HI                       7'he
`define ROUTER_OP_LUT_MAC_2_LO                       7'hf
`define ROUTER_OP_LUT_MAC_3_HI                       7'h10
`define ROUTER_OP_LUT_MAC_3_LO                       7'h11
`define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI         7'h12
`define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO         7'h13
`define ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP    7'h14
`define ROUTER_OP_LUT_ARP_TABLE_RD_ADDR              7'h15
`define ROUTER_OP_LUT_ARP_TABLE_WR_ADDR              7'h16
`define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP   7'h17
`define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR    7'h18
`define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR    7'h19
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP           7'h1a
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK         7'h1b
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP  7'h1c
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT  7'h1d
`define ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR            7'h1e
`define ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR            7'h1f
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NAME          7'h20
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NEXT_HOP_IP   7'h21
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_OUTPUT_PORT   7'h22
`define ROUTER_OP_LUT_CCCP_TABLE_RD_ADDR             7'h23
`define ROUTER_OP_LUT_CCCP_TABLE_WR_ADDR             7'h24
