...
// Number of entrties in the cccp table
#define ROUTER_OP_LUT_CCCP_TABLE_DEPTH            32
...
#define RATE_LIMIT_0_BASE_ADDR   0x2000400
#define RATE_LIMIT_1_BASE_ADDR   0x2000440
#define RATE_LIMIT_2_BASE_ADDR   0x2000480
#define RATE_LIMIT_3_BASE_ADDR   0x20004c0
#define EVT_CAP_BASE_ADDR        0x2000500
...
#define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG          0x2000048
#define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG          0x200004c
#define ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG     0x2000050
#define ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG               0x2000054
#define ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG               0x2000058
#define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG    0x200005c
#define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG     0x2000060
#define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG     0x2000064
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG            0x2000068
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG          0x200006c
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG   0x2000070
#define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG   0x2000074
#define ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG             0x2000078
#define ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG             0x200007c
#define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NAME_REG           0x2000080
#define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NEXT_HOP_IP_REG    0x2000084
#define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_OUTPUT_PORT_REG    0x2000088
#define ROUTER_OP_LUT_CCCP_TABLE_RD_ADDR_REG              0x200008c
#define ROUTER_OP_LUT_CCCP_TABLE_WR_ADDR_REG              0x2000090
...
#define RATE_LIMIT_0_ENABLE_REG   0x2000400
#define RATE_LIMIT_0_SHIFT_REG    0x2000404

// Name: rate_limiter (RATE_LIMIT_1)
// Description: Event Capture Registers
// File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
#define RATE_LIMIT_1_ENABLE_REG   0x2000440
#define RATE_LIMIT_1_SHIFT_REG    0x2000444

// Name: rate_limiter (RATE_LIMIT_2)
// Description: Event Capture Registers
// File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
#define RATE_LIMIT_2_ENABLE_REG   0x2000480
#define RATE_LIMIT_2_SHIFT_REG    0x2000484

// Name: rate_limiter (RATE_LIMIT_3)
// Description: Event Capture Registers
// File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
#define RATE_LIMIT_3_ENABLE_REG   0x20004c0
#define RATE_LIMIT_3_SHIFT_REG    0x20004c4

// Name: event_capture (EVT_CAP)
// Description: Event Capture Registers
// File: lib/verilog/core/event_capture/xml/event_capture.xml
#define EVT_CAP_ENABLE_CAPTURE_REG      0x2000500
#define EVT_CAP_SEND_PKT_REG            0x2000504
#define EVT_CAP_DST_MAC_HI_REG          0x2000508
#define EVT_CAP_DST_MAC_LO_REG          0x200050c
#define EVT_CAP_SRC_MAC_HI_REG          0x2000510
#define EVT_CAP_SRC_MAC_LO_REG          0x2000514
#define EVT_CAP_ETHERTYPE_REG           0x2000518
#define EVT_CAP_IP_DST_REG              0x200051c
#define EVT_CAP_IP_SRC_REG              0x2000520
#define EVT_CAP_MONITOR_MASK_REG        0x2000524
#define EVT_CAP_SIGNAL_ID_MASK_REG      0x2000528
#define EVT_CAP_NUM_EVTS_DROPPED_REG    0x200052c
#define EVT_CAP_UDP_SRC_PORT_REG        0x2000530
#define EVT_CAP_UDP_DST_PORT_REG        0x2000534
#define EVT_CAP_OUTPUT_PORTS_REG        0x2000538
#define EVT_CAP_RESET_TIMERS_REG        0x200053c
#define EVT_CAP_TIMER_RESOLUTION_REG    0x2000540
#define EVT_CAP_NUM_EVT_PKTS_SENT_REG   0x2000544
#define EVT_CAP_NUM_EVTS_SENT_REG       0x2000548
