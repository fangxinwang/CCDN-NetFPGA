...
@EXPORT = qw(
                ...
                ROUTER_OP_LUT_CCCP_TABLE_DEPTH
                ...
                ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NAME_REG
                ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NEXT_HOP_IP_REG
                ROUTER_OP_LUT_CCCP_TABLE_ENTRY_OUTPUT_PORT_REG
                ROUTER_OP_LUT_CCCP_TABLE_RD_ADDR_REG
                ROUTER_OP_LUT_CCCP_TABLE_WR_ADDR_REG
...
sub ROUTER_OP_LUT_CCCP_TABLE_DEPTH ()           { 32;}
...
sub EVT_CAP_BASE_ADDR ()         { 0x2000500; }
...
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG ()          { 0x2000048;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG ()          { 0x200004c;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG ()     { 0x2000050;}
sub ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG ()               { 0x2000054;}
sub ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG ()               { 0x2000058;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG ()    { 0x200005c;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG ()     { 0x2000060;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG ()     { 0x2000064;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG ()            { 0x2000068;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG ()          { 0x200006c;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG ()   { 0x2000070;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG ()   { 0x2000074;}
sub ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG ()             { 0x2000078;}
sub ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG ()             { 0x200007c;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NAME_REG ()           { 0x2000080;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NEXT_HOP_IP_REG ()    { 0x2000084;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_OUTPUT_PORT_REG ()    { 0x2000088;}
sub ROUTER_OP_LUT_CCCP_TABLE_RD_ADDR_REG ()              { 0x200008c;}
sub ROUTER_OP_LUT_CCCP_TABLE_WR_ADDR_REG ()              { 0x2000090;}
...
sub EVT_CAP_ENABLE_CAPTURE_REG ()      { 0x2000500;}
sub EVT_CAP_SEND_PKT_REG ()            { 0x2000504;}
sub EVT_CAP_DST_MAC_HI_REG ()          { 0x2000508;}
sub EVT_CAP_DST_MAC_LO_REG ()          { 0x200050c;}
sub EVT_CAP_SRC_MAC_HI_REG ()          { 0x2000510;}
sub EVT_CAP_SRC_MAC_LO_REG ()          { 0x2000514;}
sub EVT_CAP_ETHERTYPE_REG ()           { 0x2000518;}
sub EVT_CAP_IP_DST_REG ()              { 0x200051c;}
sub EVT_CAP_IP_SRC_REG ()              { 0x2000520;}
sub EVT_CAP_MONITOR_MASK_REG ()        { 0x2000524;}
sub EVT_CAP_SIGNAL_ID_MASK_REG ()      { 0x2000528;}
sub EVT_CAP_NUM_EVTS_DROPPED_REG ()    { 0x200052c;}
sub EVT_CAP_UDP_SRC_PORT_REG ()        { 0x2000530;}
sub EVT_CAP_UDP_DST_PORT_REG ()        { 0x2000534;}
sub EVT_CAP_OUTPUT_PORTS_REG ()        { 0x2000538;}
sub EVT_CAP_RESET_TIMERS_REG ()        { 0x200053c;}
sub EVT_CAP_TIMER_RESOLUTION_REG ()    { 0x2000540;}
sub EVT_CAP_NUM_EVT_PKTS_SENT_REG ()   { 0x2000544;}
sub EVT_CAP_NUM_EVTS_SENT_REG ()       { 0x2000548;}
