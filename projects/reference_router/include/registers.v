...
`define ROUTER_OP_LUT_CCCP_NOT_REQ                   7'ha
`define ROUTER_OP_LUT_CCCP_VN_NOT_MATCH              7'hb
`define ROUTER_OP_LUT_MAC_0_HI                       7'hc
`define ROUTER_OP_LUT_MAC_0_LO                       7'hd
`define ROUTER_OP_LUT_MAC_1_HI                       7'he
`define ROUTER_OP_LUT_MAC_1_LO                       7'hf
`define ROUTER_OP_LUT_MAC_2_HI                       7'h10
`define ROUTER_OP_LUT_MAC_2_LO                       7'h11
`define ROUTER_OP_LUT_MAC_3_HI                       7'h12
`define ROUTER_OP_LUT_MAC_3_LO                       7'h13
`define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI         7'h14
`define ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO         7'h15
`define ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP    7'h16
`define ROUTER_OP_LUT_ARP_TABLE_RD_ADDR              7'h17
`define ROUTER_OP_LUT_ARP_TABLE_WR_ADDR              7'h18
`define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP   7'h19
`define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR    7'h1a
`define ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR    7'h1b
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP           7'h1c
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK         7'h1d
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP  7'h1e
`define ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT  7'h1f
`define ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR            7'h20
`define ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR            7'h21
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NAME          7'h22
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_VN            7'h23
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NEXT_HOP_IP   7'h24
`define ROUTER_OP_LUT_CCCP_TABLE_ENTRY_OUTPUT_PORT   7'h25
`define ROUTER_OP_LUT_CCCP_TABLE_RD_ADDR             7'h26
`define ROUTER_OP_LUT_CCCP_TABLE_WR_ADDR             7'h27
