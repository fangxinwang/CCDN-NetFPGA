...
@EXPORT = qw(
                ...
                ROUTER_OP_LUT_CCCP_NOT_REQ_REG
                ROUTER_OP_LUT_CCCP_VN_NOT_MATCH_REG
                ...
                ROUTER_OP_LUT_CCCP_TABLE_ENTRY_VN_REG
...
sub ROUTER_OP_LUT_CCCP_NOT_REQ_REG ()                    { 0x2000028;}
sub ROUTER_OP_LUT_CCCP_VN_NOT_MATCH_REG ()               { 0x200002c;}
sub ROUTER_OP_LUT_MAC_0_HI_REG ()                        { 0x2000030;}
sub ROUTER_OP_LUT_MAC_0_LO_REG ()                        { 0x2000034;}
sub ROUTER_OP_LUT_MAC_1_HI_REG ()                        { 0x2000038;}
sub ROUTER_OP_LUT_MAC_1_LO_REG ()                        { 0x200003c;}
sub ROUTER_OP_LUT_MAC_2_HI_REG ()                        { 0x2000040;}
sub ROUTER_OP_LUT_MAC_2_LO_REG ()                        { 0x2000044;}
sub ROUTER_OP_LUT_MAC_3_HI_REG ()                        { 0x2000048;}
sub ROUTER_OP_LUT_MAC_3_LO_REG ()                        { 0x200004c;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG ()          { 0x2000050;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG ()          { 0x2000054;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG ()     { 0x2000058;}
sub ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG ()               { 0x200005c;}
sub ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG ()               { 0x2000060;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG ()    { 0x2000064;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG ()     { 0x2000068;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG ()     { 0x200006c;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG ()            { 0x2000070;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG ()          { 0x2000074;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG ()   { 0x2000078;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG ()   { 0x200007c;}
sub ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG ()             { 0x2000080;}
sub ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG ()             { 0x2000084;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NAME_REG ()           { 0x2000088;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_VN_REG ()             { 0x200008c;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_NEXT_HOP_IP_REG ()    { 0x2000090;}
sub ROUTER_OP_LUT_CCCP_TABLE_ENTRY_OUTPUT_PORT_REG ()    { 0x2000094;}
sub ROUTER_OP_LUT_CCCP_TABLE_RD_ADDR_REG ()              { 0x2000098;}
sub ROUTER_OP_LUT_CCCP_TABLE_WR_ADDR_REG ()              { 0x200009c;}
