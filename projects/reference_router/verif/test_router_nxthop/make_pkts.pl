...
add_LPM_table_entry(0,'192.168.27.0', '255.255.255.0', '192.168.27.1', 0x10);
add_LPM_table_entry(1,'192.168.26.0', '255.255.255.0', '192.168.26.1', 0x01);
add_LPM_table_entry(2,'192.168.25.0', '255.255.255.0', '192.168.25.1', 0x04);
add_LPM_table_entry(3,'192.168.24.0', '255.255.255.0', '192.168.24.1', 0x40);
