...
add_CCCP_table_entry(0, '127.1.1.1', 1, '192.168.24.1', 0x40);
add_CCCP_table_entry(1, '128.0.0.1', 1, '192.168.25.1', 0x04); #1
add_CCCP_table_entry(2, '128.0.0.1', 1, '192.168.26.1', 0x01); #0
add_CCCP_table_entry(3, '128.0.0.1', 1, '192.168.27.1', 0x10); #2
